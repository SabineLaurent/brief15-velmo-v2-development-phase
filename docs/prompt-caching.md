...
> À lire avec [`latence.md`](latence.md) (d'où vient le TTFT).
...
> provider derrière la factory, le caching est soit **gratuit et
...
était **invisible** (`None`). Corrigé dans la factory : la branche
