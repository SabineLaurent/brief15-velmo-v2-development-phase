...
- **LLM via API** : Azure AI Inference, modèle Kimi-K2.6 (remplacé par modeles openai). Aucun modèle local.
...
- **Mémoire long terme épisodique** : base vectorielle (Chroma, substituée par pgvector) pour retrouver les souvenirs pertinents par similarité.
