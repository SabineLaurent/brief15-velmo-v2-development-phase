...
- **Le canal de retour.** Quand la conseillère répond, par où ça revient au client ?
  ...
  problème de **transport**, pas d'agent : il demande une boîte de réception
  persistante côté client.
...
- **La reprise à l'initiative du bot.** Le client peut reprendre la main
  ...
  et ne le fera pas tant que personne ne peut **clore** un dossier.
...
C'est aussi l'usage qu'en fait l'industrie. La capacité n'a donc pas été annulée,
